...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelCronoTareas.setGeometry(QtCore.QRect(91, 17, 141, 31))
        font = QtGui.QFont()
        ...
        self.pushButtonAgregarTarea.setGeometry(QtCore.QRect(12, 280, 101, 29))
        font = QtGui.QFont()
        font.setFamily("Gallaecia Castelo")
        ...
        self.pushButtonModificarTarea.setGeometry(QtCore.QRect(126, 280, 101, 29))
        font = QtGui.QFont()
        font.setFamily("Gallaecia Castelo")
        ...
        self.pushButtonEliminarTarea.setGeometry(QtCore.QRect(239, 280, 101, 29))
        font = QtGui.QFont()
        font.setFamily("Gallaecia Castelo")
        ...
        self.listWidgetTareas.setGeometry(QtCore.QRect(12, 42, 610, 230))
        ...
        self.checkBoxMultiCrono.setGeometry(QtCore.QRect(363, 284, 260, 22))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/miprefijo/images/tareas2.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidgetTareas.addTab(self.tab_1, icon4, "")
        self.tab_2 = QtWidgets.QWidget()
        self.tab_2.setObjectName("tab_2")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/miprefijo/images/informes2.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidgetTareas.addTab(self.tab_2, icon5, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "v.1.0"))
