...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/miprefijo/images/informes2.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidgetTareas.addTab(self.tab_2, icon7, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "v.1.5"))
